...
echo "psqlrcFile: ${psqlrcFile}"
echo "psqlrcLine: ${psqlrcLine}"
echo "psqlrcLineEscaped: ${psqlrcLineEscaped}"
echo "psqlSetLocalPath: ${psqlSetLocalPath}"
echo "psqlSetLocalPathEscaped: ${psqlSetLocalPathEscaped}"
