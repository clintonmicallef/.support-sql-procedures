...
\prompt 'Enter a ProcessingAccount or press enter to see all', processingaccount
...
SELECT pg_temp.user_log_function(user::text, now()::timestamp , 'entrystep_incident_overview');
